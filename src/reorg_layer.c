...
void forward_reorg_layer_gpu(layer l, network net)
{
    ...
    {
#ifdef OPENCL
        cl_mem_with_offset temp0 = net.input_gpu;
        cl_mem_with_offset temp1 = l.output_gpu;
#endif
        for(i = 0; i < l.batch; ++i)
        {
#ifdef CUDA
...
#elif defined OPENCL
            copy_gpu(l.inputs, temp0, 1, temp1, 1);
            temp0.offset += l.inputs;
            temp1.offset += l.inputs;
#endif
        }
    }
    else if (l.reverse)
...
void backward_reorg_layer_gpu(layer l, network net)
{
    ...
    else if (l.extra)
    {
        int i;
#ifdef OPENCL
        cl_mem_with_offset temp0 = l.delta_gpu;
        cl_mem_with_offset temp1 = net.delta_gpu;
#endif
        for(i = 0; i < l.batch; ++i)
        {
#ifdef CUDA
...
#elif defined OPENCL
            copy_gpu(l.inputs, temp0, 1, temp1, 1);
            temp0.offset += l.outputs;
            temp1.offset += l.outputs;
#endif
        }
    }
    else if(l.reverse)
