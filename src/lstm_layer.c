...
static void increment_layer(layer *l, int steps)
{
    ...
    l->x_norm_gpu += num;
#elif defined OPENCL
    l->output_gpu.offset += num;
    l->delta_gpu.offset += num;
    l->x_gpu.offset += num;
    l->x_norm_gpu.offset += num;
#endif
}
...
#elif defined OPENCL
        state.input_gpu.offset += l.inputs*l.batch;
        l.output_gpu.offset    += l.outputs*l.batch;
        l.cell_gpu.offset      += l.outputs*l.batch;
#endif
...
#elif defined OPENCL
    state.input_gpu.offset += l.inputs*l.batch*(l.steps - 1);
    if (state.delta_gpu.exist) state.delta_gpu.offset += l.inputs*l.batch*(l.steps - 1);

    l.output_gpu.offset += l.outputs*l.batch*(l.steps - 1);
    l.cell_gpu.offset += l.outputs*l.batch*(l.steps - 1);
    l.delta_gpu.offset += l.outputs*l.batch*(l.steps - 1);
#endif
...
#elif defined OPENCL
        if (i != 0) {
            cl_mem_with_offset temp = l.cell_gpu;
            temp.offset -= l.outputs*l.batch;
            copy_gpu(l.outputs*l.batch, temp, 1, l.prev_cell_gpu, 1);
        }
#endif
...
#elif defined OPENCL
        if (i != 0) {
            cl_mem_with_offset temp = l.output_gpu;
            temp.offset -= l.outputs*l.batch;
            copy_gpu(l.outputs*l.batch, temp, 1, l.prev_state_gpu, 1);
        }
#endif
...
#elif defined OPENCL
        if (i == 0) {
            l.dh_gpu.exist = false;
        } else {
            l.dh_gpu = l.delta_gpu;
            l.dh_gpu.offset -= l.outputs*l.batch;
        }
#endif
...
#elif defined OPENCL
        state.input_gpu.offset -= l.inputs*l.batch;
        if (state.delta_gpu.exist) state.delta_gpu.offset -= l.inputs*l.batch;
        l.output_gpu.offset -= l.outputs*l.batch;
        l.cell_gpu.offset -= l.outputs*l.batch;
        l.delta_gpu.offset -= l.outputs*l.batch;
#endif
